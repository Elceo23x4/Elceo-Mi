...
export const GET = withApiErrorBoundary(async (request: Request) => {
  ...
  const commercial = guardRouteCommercialEntitlement({ routePath: '/api/analytics/latest', method: 'GET', featureKey: 'premium.full_access', snapshot: await resolveUserCommercialEntitlementSnapshot(subject.userId) });
