...
export const GET = withApiErrorBoundary(async (request: Request) => {
  ...
  const snapshot = await getApplicationStateRuntime().journalInfluence.getLatestJournalInfluenceSnapshot(subject.subjectKind, subject.subjectId, assetScope, timeframeScope);
