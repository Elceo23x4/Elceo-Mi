...
export const GET = withApiErrorBoundary(async (request: Request) => {
  ...
  const replay = await getTenantApplicationStateRuntime(subject).portfolio.getPortfolioEntityReplay('user', subject.subjectId, entityKind as 'watchlist_entry' | 'position' | 'action_item', entityId);
