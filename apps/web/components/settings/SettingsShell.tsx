...
export function SettingsShell({ initialState, billing }: SettingsShellProps) {
  ...
  return (
    <div className="elceo-shell-rhythm elceo-settings-rhythm">
      ...
      <Surface className="elceo-shell-panel" style={{ padding: '1rem', display: 'grid', gap: '0.6rem' }}>
      ...
      <Surface className="elceo-shell-panel elceo-shell-panel-contrast" style={{ padding: '1rem', display: 'grid', gap: '0.6rem' }}>
      ...
      <Surface className="elceo-shell-panel elceo-shell-panel-deep" style={{ padding: '1rem', display: 'grid', gap: '0.6rem' }}>
