# C6-A7 Cognition Calibration Hardening

Deterministic fixture-based calibration layer for scoring, weighting, contradiction detection, confidence decomposition, and guardrails.

- Fixture-only dry-run logic.
