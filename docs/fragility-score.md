...
The engine consumes immutable stage-specific snapshots and does not reconstruct later evidence, rerank analogs, invent positioning totals, or override upstream invalidation. Optional missing evidence reduces coverage unless structurally unavailable. Historical dispersion is not current-event probability. IFP-8 has not started.
