# C6-A4 News / Extraction / Filings Shells

C6-A4 adds fixture/dry-run backend shells for news, extraction, SEC/EDGAR filings, earnings/company events, ETF flows/holdings, and narrative/geopolitical risk evidence.

- Fixture-only and dry-run only.
