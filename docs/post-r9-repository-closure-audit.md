...
5. **Route enforcement is now matrix-backed but not fully closed.** The completed matrix covers 145 API route files. Totals are `verified`: 113, `partial`: 27, `gap_found`: 3, `environment_verification_required`: 1, `not_applicable`: 1. The three `gap_found` rows are the step-up commercial mutation routes.
6. **Provider orchestration is adapter-backed but not live-closed.** The corrected provider matrix covers 43 `PROVIDER_SOURCE_IDS` entries and distinguishes direct adapters, generic fixture/capability mappings, dry-run-only paths, shell descriptors, and live activation blockers. Tiingo and CFTC are not adapter-absent; they have concrete adapter classes, but live and external verification states differ.
...
|---|---:|---|---:|---|---|---|---|---|---:|---:|---|---:|---|---|---|---|
| /api/account/access-check | POST | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/account/access-decisions | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
...
| /api/account/billing/policy | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/account/billing/policy/transitions | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/account/billing/reconciliation-runs | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/account/billing | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/account/entitlements | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/account/profile/social-identifiers | GET,PATCH | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/account/usage | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/audit | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/activate | POST | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/cancel-at-period-end | POST | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/change-plan | POST | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/expire | POST | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/operations/failures | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/operations/retry-candidates | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/operations/subject | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/operations/summary | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/orchestration/latest | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/orchestration/runs | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/orchestration/subject | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/past-due | POST | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/pause | POST | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/policy | GET | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/policy/transitions | GET | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/provider-events | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/provider-plan-mapping | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/provider-plan-mappings | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/renew | POST | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/resume | POST | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/billing/trial | POST | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/commercial/metrics | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | blocked/gated | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/commercial/users/{userId}/control-snapshot | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | admin target path | path:userId | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/commercial/users/{userId}/gift-focus-plan | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | admin target path | path:userId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | gap_found | F-020 trusts body.stepUpVerification without server-side challenge binding/consumption |
| /api/admin/commercial/users/{userId}/restrict | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | admin target path | path:userId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | gap_found | F-020 trusts body.stepUpVerification without server-side challenge binding/consumption |
| /api/admin/commercial/users/{userId}/retract-focus-gift | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | admin target path | path:userId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | gap_found | F-020 trusts body.stepUpVerification without server-side challenge binding/consumption |
| /api/admin/entitlements/override | POST | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/entitlements/plan | POST | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/entitlements/state | POST | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/freshness | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/market-evidence/cognition | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/market-evidence/inspection | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | blocked/gated | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/market-evidence/payload-replay | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/market-evidence/payloads | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/market-evidence/provider-request | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/market-evidence/provider-response | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/market-evidence/quality | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/market-evidence/reasoning-input | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/market-evidence/scheduled-ingestion/dry-run | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/market-evidence/scheduled-ingestion/inspection | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/market-evidence/scheduled-ingestion/policies | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/market-evidence/scheduled-ingestion/replay | GET,POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/market-evidence/scheduled-ingestion/runs | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/market-evidence/weighted | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/ops | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/providers | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/security/step-up/challenge | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | no | no | yes | no | blocked/gated | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/security/step-up/readiness | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/security/step-up/verify | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/seo/feed | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/seo/sitemap | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/admin/system-summary | GET | requireFeatureAccess+requireInternalRouteAccess | yes | admin.read | no | internal operator | none | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/analytics/generate | POST | requireFeatureAccess | no | feature_access | no | not_proven | none | not_proven | yes | yes | not_proven | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | partial | one or more controls/test assertions not fully proven |
| /api/analytics/latest | GET | requireFeatureAccess+guardRouteCommercialEntitlement | no | feature_access | yes | not_proven | none | commercial guard | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | partial | one or more controls/test assertions not fully proven |
| /api/analytics/top-behaviors | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/analytics/top-setups | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
...
| /api/coaching/action-plan | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/coaching/focus | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/coaching/generate | POST | requireFeatureAccess | no | feature_access | no | not_proven | none | not_proven | yes | yes | not_proven | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | partial | one or more controls/test assertions not fully proven |
...
| /api/internal/billing/orchestration/retry | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/internal/billing/policy/evaluate | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/internal/billing/provider-events/replay | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | no | no | yes | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/internal/billing/provider-events | POST | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/internal/billing/reconcile/retry | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/internal/billing/reconcile | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/internal/market-evidence/tiingo/fixture-ingest | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | yes | yes | yes | yes | blocked/gated | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
...
| /api/journal/cases/{caseId}/adjust | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:caseId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/journal/cases/{caseId}/cancel | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:caseId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/journal/cases/{caseId}/close | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:caseId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/journal/cases/{caseId}/execute | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:caseId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/journal/cases/{caseId}/partial-close | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:caseId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/journal/cases/{caseId}/plan | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:caseId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/journal/cases/{caseId}/replay | GET | requireAuthenticatedSubject | no | none | no | subject helper | path:caseId | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/journal/cases/{caseId}/review | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:caseId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/journal/cases/{caseId} | GET | requireAuthenticatedSubject | no | none | no | subject helper | path:caseId | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/journal/cases | GET,POST | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
...
| /api/journal/influence/generate | POST | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | yes | yes | not_proven | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
...
| /api/notifications/delivery/dispatch | POST | requireInternalRouteAccess | yes | none | no | internal operator | none | not_proven | yes | yes | not_proven | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/notifications/health | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/notifications/inbox | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/notifications/subscriptions/{subscriptionId} | PATCH | requireAuthenticatedSubject | no | none | no | subject helper | path:subscriptionId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/notifications/subscriptions | GET,POST | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/notifications/summary | GET | requireFeatureAccess+guardRouteCommercialEntitlement | no | feature_access | yes | not_proven | none | commercial guard | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | partial | one or more controls/test assertions not fully proven |
| /api/notifications/targets/{targetId}/disable | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:targetId | not_proven | yes | yes | not_proven | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/notifications/targets/{targetId}/enable | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:targetId | not_proven | yes | yes | not_proven | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/notifications/targets | GET,POST | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/notifications/verification/consume | POST | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/notifications/verification/issue | POST | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/ops/notifications/expire-verifications | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | yes | yes | not_proven | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/ops/notifications/process-feedback | POST | requireFeatureAccess+requireInternalRouteAccess | yes | admin.ops | no | internal operator | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/portfolio/actions/{actionId}/complete | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:actionId | not_proven | yes | yes | not_proven | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/portfolio/actions/{actionId}/dismiss | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:actionId | not_proven | yes | yes | not_proven | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/portfolio/actions/{actionId} | GET,PATCH | requireAuthenticatedSubject | no | none | no | subject helper | path:actionId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/portfolio/actions | GET,POST | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
...
| /api/portfolio/positions/{positionId}/close | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:positionId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/portfolio/positions/{positionId}/open | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:positionId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
...
| /api/portfolio/positions/{positionId} | GET,PATCH | requireAuthenticatedSubject | no | none | no | subject helper | path:positionId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
...
| /api/portfolio/positions | GET,POST | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/portfolio/replay | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
...
| /api/portfolio/snapshot/generate | POST | requireFeatureAccess | no | feature_access | no | not_proven | none | not_proven | yes | yes | not_proven | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | partial | one or more controls/test assertions not fully proven |
| /api/portfolio/watchlist/{entryId}/archive | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:entryId | not_proven | yes | yes | not_proven | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/portfolio/watchlist/{entryId} | GET,PATCH | requireAuthenticatedSubject | no | none | no | subject helper | path:entryId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/portfolio/watchlist/{entryId}/status | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:entryId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/portfolio/watchlist/{entryId}/thesis-health | POST | requireAuthenticatedSubject | no | none | no | subject helper | path:entryId | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/portfolio/watchlist | GET,POST | requireFeatureAccess+guardRouteCommercialEntitlement | no | feature_access | yes | not_proven | none | commercial guard | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | partial | one or more controls/test assertions not fully proven |
| /api/refresh/freshness | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/refresh/history | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/refresh/latest | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/refresh/run | POST | requireFeatureAccess | no | feature_access | no | not_proven | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | partial | one or more controls/test assertions not fully proven |
| /api/workspace/agenda | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/workspace/current | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/workspace/freshness | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/workspace/history | GET | requireAuthenticatedSubject | no | none | no | subject helper | subject | not_proven | no | no | not_proven | no | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | verified | none |
| /api/workspace/refresh | POST | requireFeatureAccess | no | feature_access | no | not_proven | none | not_proven | yes | yes | yes | yes | not_applicable | apps/web/tests/route-runtime.test.ts exact route literal | partial | one or more controls/test assertions not fully proven |
...
- `implemented`: 0.
- `fixture_only`: 1.
- `fixture_only_partial_source_mapping`: 32.
- `dry_run_only`: 1.
- `shell_or_descriptor_only`: 8.
- `external_activation_blocker`: 1.
- `not_present`: 0.

### Complete provider-by-provider matrix

| Source ID | Registry descriptor | Adapter class | Adapter file | Source-ID mapping | Fixture execution | Dry-run | Live code path | Live verified | Credentials | Schema/normalizer | Persistence | Scheduled-ingestion wiring | Timeout/retry/quota controls | Tests | Classification | Blocker |
|---|---|---|---|---|---:|---|---|---:|---|---|---|---|---|---|---|---|
| tiingo_market_data | market_data; registry_status=fixture_ready; stage=fixture_ready | TiingoMarketDataAdapter | services/reasoning/src/provider-sources/tiingo/tiingo-adapter.ts | direct | yes | yes | yes_disabled_by_default | no | api_key_required | yes normalizer/schema | provider request/response/payload repositories available | scheduled ingestion candidate/tests | not centralized; API Gate required | adapter test present | external_activation_blocker | live credentials/schema smoke/rate limits not verified |
| public_market_price_exchange | market_data; registry_status=dry_run_ready; stage=dry_run_ready | none | absent | no | registry only | yes | no | no | none | descriptor schema only | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | registry only/not_proven | dry_run_only | adapter/source-id wiring absent or shell-only |
| index_futures_shell | market_data; registry_status=not_started; stage=not_started | none | absent | no | no | not_proven | no | no | unknown | descriptor schema only | registry only | policy/wiring not proven | not centralized; API Gate required | registry only/not_proven | shell_or_descriptor_only | adapter/source-id wiring absent or shell-only |
| fred_macro | macro_official; registry_status=not_started; stage=not_started | MacroCalendarFixtureAdapter; MacroIndicatorFixtureAdapter; StressConditionsFixtureAdapter | services/reasoning/src/provider-sources/macro-calendar/macro-calendar-adapter.ts; services/reasoning/src/provider-sources/macro-indicators/macro-indicator-adapter.ts; services/reasoning/src/provider-sources/stress-conditions/stress-conditions-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| us_treasury_official | macro_official; registry_status=not_started; stage=not_started | TreasuryFixtureAdapter | services/reasoning/src/provider-sources/treasury/treasury-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| federal_reserve_official | macro_official; registry_status=not_started; stage=not_started | CentralBankFixtureAdapter | services/reasoning/src/provider-sources/central-bank/central-bank-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| ecb_official | macro_official; registry_status=not_started; stage=not_started | CentralBankFixtureAdapter | services/reasoning/src/provider-sources/central-bank/central-bank-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| boe_official | macro_official; registry_status=not_started; stage=not_started | none | absent | no | no | not_proven | no | no | unknown | descriptor schema only | registry only | policy/wiring not proven | not centralized; API Gate required | registry only/not_proven | shell_or_descriptor_only | adapter/source-id wiring absent or shell-only |
| boj_official | macro_official; registry_status=not_started; stage=not_started | CentralBankFixtureAdapter | services/reasoning/src/provider-sources/central-bank/central-bank-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| eurostat_official | macro_official; registry_status=not_started; stage=not_started | MacroIndicatorFixtureAdapter | services/reasoning/src/provider-sources/macro-indicators/macro-indicator-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| bls_official | macro_official; registry_status=not_started; stage=not_started | MacroIndicatorFixtureAdapter | services/reasoning/src/provider-sources/macro-indicators/macro-indicator-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| bea_official | macro_official; registry_status=not_started; stage=not_started | MacroIndicatorFixtureAdapter | services/reasoning/src/provider-sources/macro-indicators/macro-indicator-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| census_official | macro_official; registry_status=not_started; stage=not_started | MacroIndicatorFixtureAdapter | services/reasoning/src/provider-sources/macro-indicators/macro-indicator-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| ons_official | macro_official; registry_status=not_started; stage=not_started | MacroIndicatorFixtureAdapter | services/reasoning/src/provider-sources/macro-indicators/macro-indicator-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| destatis_official | macro_official; registry_status=not_started; stage=not_started | MacroIndicatorFixtureAdapter | services/reasoning/src/provider-sources/macro-indicators/macro-indicator-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| ifo_shell | macro_official; registry_status=not_started; stage=not_started | none | absent | no | no | not_proven | no | no | unknown | descriptor schema only | registry only | policy/wiring not proven | not centralized; API Gate required | registry only/not_proven | shell_or_descriptor_only | adapter/source-id wiring absent or shell-only |
| zew_shell | macro_official; registry_status=not_started; stage=not_started | none | absent | no | no | not_proven | no | no | unknown | descriptor schema only | registry only | policy/wiring not proven | not centralized; API Gate required | registry only/not_proven | shell_or_descriptor_only | adapter/source-id wiring absent or shell-only |
| ism_shell | macro_official; registry_status=not_started; stage=not_started | MacroIndicatorFixtureAdapter | services/reasoning/src/provider-sources/macro-indicators/macro-indicator-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| cftc_cot | positioning; registry_status=not_started; stage=not_started | CftcCotAdapter | services/reasoning/src/provider-sources/cot/cot-adapter.ts | direct | yes | yes | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | scheduled ingestion candidate/tests | not centralized; API Gate required | adapter test present | fixture_only | live credentials/schema smoke/rate limits not verified |
| marketaux_news | news_extraction; registry_status=not_started; stage=not_started | CryptoEarningsGeopoliticalFixtureAdapter | services/reasoning/src/provider-sources/crypto-earnings-geopolitical/crypto-earnings-geopolitical-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| newsapi_news | news_extraction; registry_status=not_started; stage=not_started | CryptoEarningsGeopoliticalFixtureAdapter | services/reasoning/src/provider-sources/crypto-earnings-geopolitical/crypto-earnings-geopolitical-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| gdelt_news | news_extraction; registry_status=not_started; stage=not_started | CryptoEarningsGeopoliticalFixtureAdapter | services/reasoning/src/provider-sources/crypto-earnings-geopolitical/crypto-earnings-geopolitical-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| finnhub_news | news_extraction; registry_status=not_started; stage=not_started | CryptoEarningsGeopoliticalFixtureAdapter | services/reasoning/src/provider-sources/crypto-earnings-geopolitical/crypto-earnings-geopolitical-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| firecrawl_extraction | news_extraction; registry_status=not_started; stage=not_started | none | absent | no | no | not_proven | no | no | unknown | descriptor schema only | registry only | policy/wiring not proven | not centralized; API Gate required | registry only/not_proven | shell_or_descriptor_only | adapter/source-id wiring absent or shell-only |
| sec_edgar | filings_company_etf; registry_status=not_started; stage=not_started | RegulatoryLiquidityFixtureAdapter | services/reasoning/src/provider-sources/regulatory-liquidity/regulatory-liquidity-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| etf_flows_shell | filings_company_etf; registry_status=not_started; stage=not_started | none | absent | no | no | not_proven | no | no | unknown | descriptor schema only | registry only | policy/wiring not proven | not centralized; API Gate required | registry only/not_proven | shell_or_descriptor_only | adapter/source-id wiring absent or shell-only |
| earnings_filings_shell | filings_company_etf; registry_status=not_started; stage=not_started | BankReportsFixtureAdapter; CryptoEarningsGeopoliticalFixtureAdapter | services/reasoning/src/provider-sources/bank-reports/bank-reports-adapter.ts; services/reasoning/src/provider-sources/crypto-earnings-geopolitical/crypto-earnings-geopolitical-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| crypto_exchange_public | crypto; registry_status=not_started; stage=not_started | CryptoEarningsGeopoliticalFixtureAdapter | services/reasoning/src/provider-sources/crypto-earnings-geopolitical/crypto-earnings-geopolitical-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| crypto_onchain_public | crypto; registry_status=not_started; stage=not_started | none | absent | no | no | not_proven | no | no | unknown | descriptor schema only | registry only | policy/wiring not proven | not centralized; API Gate required | registry only/not_proven | shell_or_descriptor_only | adapter/source-id wiring absent or shell-only |
| crypto_derivatives_shell | crypto; registry_status=not_started; stage=not_started | none | absent | no | no | not_proven | no | no | unknown | descriptor schema only | registry only | policy/wiring not proven | not centralized; API Gate required | registry only/not_proven | shell_or_descriptor_only | adapter/source-id wiring absent or shell-only |
| volatility_metric_source | risk_liquidity; registry_status=not_started; stage=not_started | RiskMarketStructureFixtureAdapter | services/reasoning/src/provider-sources/risk-market-structure/risk-market-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| credit_stress_source | risk_liquidity; registry_status=not_started; stage=not_started | StressConditionsFixtureAdapter | services/reasoning/src/provider-sources/stress-conditions/stress-conditions-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| liquidity_condition_source | risk_liquidity; registry_status=not_started; stage=not_started | StressConditionsFixtureAdapter; RiskMarketStructureFixtureAdapter | services/reasoning/src/provider-sources/stress-conditions/stress-conditions-adapter.ts; services/reasoning/src/provider-sources/risk-market-structure/risk-market-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| financial_conditions_source | risk_liquidity; registry_status=not_started; stage=not_started | StressConditionsFixtureAdapter | services/reasoning/src/provider-sources/stress-conditions/stress-conditions-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| public_equity_breadth_sources | risk_liquidity; registry_status=not_started; stage=not_started | RiskMarketStructureFixtureAdapter | services/reasoning/src/provider-sources/risk-market-structure/risk-market-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| calculated_internal_conditions | risk_liquidity; registry_status=not_started; stage=not_started | RiskMarketStructureFixtureAdapter; StressConditionsFixtureAdapter | services/reasoning/src/provider-sources/risk-market-structure/risk-market-adapter.ts; services/reasoning/src/provider-sources/stress-conditions/stress-conditions-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| equity_index_breadth_indicator | risk_liquidity; registry_status=not_started; stage=not_started | RiskMarketStructureFixtureAdapter | services/reasoning/src/provider-sources/risk-market-structure/risk-market-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| imf_official | macro_official; registry_status=not_started; stage=not_started | MacroIndicatorFixtureAdapter | services/reasoning/src/provider-sources/macro-indicators/macro-indicator-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| world_bank_official | macro_official; registry_status=not_started; stage=not_started | MacroIndicatorFixtureAdapter | services/reasoning/src/provider-sources/macro-indicators/macro-indicator-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| oecd_official | macro_official; registry_status=not_started; stage=not_started | MacroIndicatorFixtureAdapter | services/reasoning/src/provider-sources/macro-indicators/macro-indicator-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| bis_official | macro_official; registry_status=not_started; stage=not_started | RiskMarketStructureFixtureAdapter | services/reasoning/src/provider-sources/risk-market-structure/risk-market-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| uk_dmo_official | macro_official; registry_status=not_started; stage=not_started | TreasuryFixtureAdapter | services/reasoning/src/provider-sources/treasury/treasury-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
| japan_mof_official | macro_official; registry_status=not_started; stage=not_started | TreasuryFixtureAdapter | services/reasoning/src/provider-sources/treasury/treasury-adapter.ts | capability/generic | yes | not_proven | fixture_only_no_live | no | unknown | yes normalizer/schema | provider request/response/payload repositories available | policy/wiring not proven | not centralized; API Gate required | adapter test present | fixture_only_partial_source_mapping | live credentials/schema smoke/rate limits not verified |
