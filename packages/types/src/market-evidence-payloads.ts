...
export type NormalizedGeopoliticalRiskEvent = { eventId: string; region: string; publishedAt: string; severity: 'low'|'medium'|'high'|'critical'; title: string; importanceScore: number; relatedAssets: string[]; sourceUrl: string | null; providerId: string; };
