import type { MarketReasoningAsset, ProviderSourceId } from './provider-source-registry';
...
export type OfficialMacroSourceDescriptor = { sourceId: OfficialMacroSourceId; providerSourceId: ProviderSourceId; displayName: string; region: OfficialMacroRegion; releaseKinds: OfficialMacroReleaseKind[]; policyKinds: OfficialMacroPolicyKind[]; evidenceClasses: OfficialMacroEvidenceClass[]; assetRelevance: MarketReasoningAsset[]; fixtureMode: OfficialMacroFixtureMode; activationStatus: OfficialMacroActivationStatus; liveBlockedByDefault: true; };
...
export type OfficialMacroFixturePayload = { fixtureId: string; sourceId: OfficialMacroSourceId; region: OfficialMacroRegion; observedAt: string; period: string; title: string; releaseKind?: OfficialMacroReleaseKind; policyKind?: OfficialMacroPolicyKind; headlineValue?: string; prior?: string; forecast?: string; actual?: string; surpriseDirection?: 'upside'|'downside'|'inline'; evidenceClass: OfficialMacroEvidenceClass; assetRelevance: MarketReasoningAsset[]; narrativeSummary: string; freshnessState: 'fresh'|'stale'; };
export type OfficialMacroNormalizedEvidence = { evidenceId: string; sourceId: OfficialMacroSourceId; region: OfficialMacroRegion; releaseKind?: OfficialMacroReleaseKind; policyKind?: OfficialMacroPolicyKind; evidenceClass: OfficialMacroEvidenceClass; observedAt: string; freshnessState: 'fresh'|'stale'; assetRelevance: MarketReasoningAsset[]; directionalPressure?: 'inflationary'|'disinflationary'|'hawkish'|'dovish'|'risk_on'|'risk_off'|'neutral'; qualityHints: string[]; narrative: string; rawFixtureId: string; };
