...
try{
 ...
 const dup=duplicatePrefixes(files); if(dup.length){console.warn('Warning: duplicate numeric prefixes detected; full filename ordering remains canonical and duplicates are not fatal:'); dup.forEach(d=>console.warn(` - ${d.prefix}: ${d.files.join(', ')}`));}
