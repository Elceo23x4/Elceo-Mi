...
export type SecurityIdempotencyRepository = { getIdempotencyRecord(idempotencyKey: string): Promise<PersistedSecurityIdempotencyRecord | null>; saveIdempotencyRecord(record: PersistedSecurityIdempotencyRecord): Promise<void>; completeIdempotencyRecord(idempotencyKey: string, responseHash: string, metadataJson: string, completedAt: string): Promise<void>; failIdempotencyRecord(idempotencyKey: string, metadataJson: string, failedAt: string): Promise<void>; cleanupExpiredIdempotencyRecords(asOfIso: string): Promise<number>; };
