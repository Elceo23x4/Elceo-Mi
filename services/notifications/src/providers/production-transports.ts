...
export class PostmarkEmailDeliveryTransport extends JsonTransport {
  constructor(private token:string,private from:string,private name:string|null,private replyTo:string|null,private stream='outbound',timeout=10_000,fetcher?:Fetch){super('postmark',timeout,fetcher)}
...
export class OneSignalWebPushDeliveryTransport extends JsonTransport {
  constructor(private appId:string,private apiKey:string,timeout=10_000,fetcher?:Fetch){super('onesignal_web_push',timeout,fetcher)}
