...
import type { KickOffDashboardContextArtifact } from '@elceo/types';
...
export type CanonicalArtifact<T> = EvidenceOrCognitionArtifact<T> | DashboardProjectionArtifact<T> | (KickOffDashboardContextArtifact & { payload: T });
