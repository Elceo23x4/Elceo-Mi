...
export type CanonicalReasoningInputIdentityManifest={evidenceIdentities:readonly string[];asset:string;horizon:string;weightingPolicyVersion:string;ruleVersions:readonly string[];cognitionContractVersion:string;freshnessPolicyVersion:string;freshnessMs:number;evaluationEpoch:number};
