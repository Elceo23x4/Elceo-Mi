...
const defaultVerifier: ReactionObservationVerifier = (envelope) => ({ effectiveReliability:'unverified', trustBasis:'missing_verifier', verificationRef:'missing_verifier', verifiedAt:envelope.reactionInput.candles.at(-1)?.timestamp ?? envelope.reactionInput.eventTime ?? '1970-01-01T00:00:00.000Z' });
