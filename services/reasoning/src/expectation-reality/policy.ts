export const EXPECTATION_REALITY_POLICY_V1 = {
  ...
  eventInterpretation: { materialSurpriseScore: 40, reliableProvenance: ['verified', 'replay'] as const, timeline: { version: 'event-price-timeline-v1', acceptanceVolUnits: 0.35, phaseAbsorption: { opposingExcursionVolUnits: 0.5, terminalBoundaryVolUnits: 0.3 } } as const },
