...
export function buildMemorySnapshotHash(snapshot: { analogMemoryId: string; featureContentHash: string; stageFeatureTimelineHash?: string; sourceAssessmentEvidenceHash: string; availableAt: string }[]): string { return historicalHash(snapshot); }
