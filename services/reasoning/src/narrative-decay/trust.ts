...
export function validateNoTrustPromotion(p:NarrativePriceObservation):void{if(p.effectiveReliability==='verified'&&p.reliability!=='verified')throw new Error('narrative_observation_trust_promotion');}
