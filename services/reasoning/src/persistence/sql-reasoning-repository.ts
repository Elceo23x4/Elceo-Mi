...
export class SqlReasoningPersistenceRepository implements ReasoningPersistenceRepository {
  ...
  constructor(
    ...
    historicalAnalogRepository: HistoricalAnalogRepository = new SqlHistoricalAnalogRepository(queryDb)
  ) {
