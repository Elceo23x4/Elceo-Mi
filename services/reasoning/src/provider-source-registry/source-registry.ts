...
['fred_macro','us_treasury_official','federal_reserve_official','ecb_official','boe_official','boj_official','eurostat_official','bls_official','bea_official','census_official','ons_official','destatis_official','ifo_shell','zew_shell','ism_shell','imf_official','world_bank_official','oecd_official','bis_official','uk_dmo_official','japan_mof_official'].forEach((id)=>add(id as ProviderSourceId,'macro_official',id,['de30','dxy','eur_usd','gbp_usd','nasdaq_100','sp500','usd_jpy','xau_usd']));
