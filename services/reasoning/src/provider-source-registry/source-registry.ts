...
coverage('aud_usd',['tiingo_market_data','federal_reserve_official','fred_macro','oecd_official','imf_official','cftc_cot','marketaux_news'],['rba_shell_planned','australia_macro_shell_needed','china_global_demand_context','commodities_risk_sentiment','fed_us_macro','dxy_yield_differential','cot_positioning']),
coverage('usd_chf',['tiingo_market_data','federal_reserve_official','fred_macro','ecb_official','bis_official','cftc_cot','marketaux_news'],['snb_shell_planned','swiss_macro_shell_needed','safe_haven_risk_off','fed_us_macro','dxy_yield_differential','european_risk_context','cot_positioning']),
coverage('nzd_usd',['tiingo_market_data','federal_reserve_official','fred_macro','oecd_official','imf_official','cftc_cot','marketaux_news'],['rbnz_shell_planned','new_zealand_macro_shell_needed','dairy_commodity_shell_needed','china_global_demand_context','fed_us_macro','dxy_risk_sentiment','cot_positioning']),
coverage('usd_cad',['tiingo_market_data','federal_reserve_official','fred_macro','oecd_official','bis_official','cftc_cot','marketaux_news'],['boc_shell_planned','canada_macro_shell_needed','oil_energy_context','fed_us_macro','dxy_us_ca_yield_differential','cot_positioning']),
