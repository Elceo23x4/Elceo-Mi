...
import { assertLivePolicyAuthority, buildProviderAdmissionId, buildProviderRequestFingerprint, type ProviderControlPolicy, type ProviderControlPolicyResolver, type ProviderControlSnapshot, type ProviderControlStore, type ProviderReservation, type ProviderSettlementState } from './provider-control/index';
...
const POLICY_REASONS=new Set(['provider_control_policy_not_approved','provider_control_policy_scope_mismatch']);
...
export async function executeProviderApiGateRequest(req:ProviderRuntimeRequest,adapter?:MarketEvidenceProviderAdapter,context:ProviderApiGateExecutionContext={}):Promise<ProviderApiGateExecutionResult> {
  let decision=resolveProviderRuntimeRequest(req),response:ProviderRuntimeResponse|null=null,reservation:ProviderReservation|undefined,controlSnapshot:ProviderControlSnapshot|undefined,providerInvoked=false,settlementState:ProviderSettlementState='not_required';
