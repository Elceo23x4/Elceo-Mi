...
export const TIINGO_FIXTURES: Record<string, TiingoFixtureResponse> = {
  xau_usd: {
    request: { requestId: 'fixture-xau-usd', asset: 'xau_usd', ticker: 'XAUUSD', startDate: '2026-01-01', endDate: '2026-01-03', frequency: 'daily', requestedAt: baseRequestedAt, sourceMode: 'fixture' },
    bars: [
  ...
  eur_usd: {
    request: { requestId: 'fixture-eur-usd', asset: 'eur_usd', ticker: 'EURUSD', startDate: '2026-01-01', endDate: '2026-01-03', frequency: 'daily', requestedAt: baseRequestedAt, sourceMode: 'fixture' },
    bars: [
  ...
  btc_usd: {
    request: { requestId: 'fixture-btc-usd', asset: 'btc_usd', ticker: 'BTCUSD', startDate: '2026-01-01', endDate: '2026-01-03', frequency: 'daily', requestedAt: baseRequestedAt, sourceMode: 'fixture' },
    bars: [
  ...
  nasdaq_100: {
    request: { requestId: 'fixture-nasdaq-100', asset: 'nasdaq_100', ticker: 'QQQ', startDate: '2026-01-01', endDate: '2026-01-03', frequency: 'daily', requestedAt: baseRequestedAt, sourceMode: 'fixture' },
    bars: [
