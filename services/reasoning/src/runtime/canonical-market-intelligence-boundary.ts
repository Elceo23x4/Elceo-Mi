...
import { assertMarketProviderReliabilityRuleSetValid, evaluateAssetProviderCoverage, evaluateProviderReliability, evaluateProviderReliabilityForEvidenceItem, evaluateProviderReliabilityForWeightedItem, evaluateProviderReliabilityForWeightedSnapshot, getMarketProviderReliabilityCoverageReport, getMarketProviderReliabilityRuleSetSnapshot, listMarketProviderReliabilityRules, listMarketProviderReliabilityWarnings } from '../provider-reliability/index';
...
export class CanonicalMarketIntelligenceBoundaryService {
  ...
  evaluateProviderReliability(input: Parameters<typeof evaluateProviderReliability>[0]) { return evaluateProviderReliability(input); }
  evaluateProviderReliabilityForEvidenceItem(evidenceItem: Parameters<typeof evaluateProviderReliabilityForEvidenceItem>[0], options?: Parameters<typeof evaluateProviderReliabilityForEvidenceItem>[1]) { return evaluateProviderReliabilityForEvidenceItem(evidenceItem, options); }
  evaluateProviderReliabilityForWeightedItem(weightedItem: Parameters<typeof evaluateProviderReliabilityForWeightedItem>[0], options?: Parameters<typeof evaluateProviderReliabilityForWeightedItem>[1]) { return evaluateProviderReliabilityForWeightedItem(weightedItem, options); }
  evaluateProviderReliabilityForWeightedSnapshot(weightedSnapshot: Parameters<typeof evaluateProviderReliabilityForWeightedSnapshot>[0], options?: Parameters<typeof evaluateProviderReliabilityForWeightedSnapshot>[1]) { return evaluateProviderReliabilityForWeightedSnapshot(weightedSnapshot, options); }
  evaluateAssetProviderCoverage(asset: Parameters<typeof evaluateAssetProviderCoverage>[0], evidenceClasses?: Parameters<typeof evaluateAssetProviderCoverage>[1], options?: Parameters<typeof evaluateAssetProviderCoverage>[2]) { return evaluateAssetProviderCoverage(asset, evidenceClasses, options); }
  getMarketProviderReliabilityRuleSetSnapshot(asOfIso?: string) { return getMarketProviderReliabilityRuleSetSnapshot(asOfIso); }
  getMarketProviderReliabilityCoverageReport(asOfIso?: string) { return getMarketProviderReliabilityCoverageReport(asOfIso); }
  assertMarketProviderReliabilityRuleSetValid() { return assertMarketProviderReliabilityRuleSetValid(); }
  listMarketProviderReliabilityWarnings(asset?: Parameters<typeof listMarketProviderReliabilityWarnings>[0]) { return listMarketProviderReliabilityWarnings(asset); }
  listMarketProviderReliabilityRules(asset?: Parameters<typeof listMarketProviderReliabilityRules>[0]) { return listMarketProviderReliabilityRules(asset); }
